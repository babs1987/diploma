...
class AsyncToSync:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # core event loop's thread if it's there, otherwise make a new loop
        # in this thread.
        try:
...
class SyncToAsync:
    ...
    outermost), this will just be the core thread. This is achieved by idling
    ...
    # Storage for core event loop references
